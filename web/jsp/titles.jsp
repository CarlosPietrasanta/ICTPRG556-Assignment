    ...
    <body>
            ...
            <tbody>
                <c:choose>
                    <c:when test="${not empty sessionScope.cart}">
                        ...
                        <tr>
                            <td>Order Total: $<fmt:formatNumber value="${totalCostOfOrder}" type="number" minFractionDigits="2" /></td>
                        </tr>
                    </c:when>
                    <c:otherwise>
        ...
        <form name="form1" method="post" action="./books">
            ...
            <table>
                <thead>
                    <tr>
                        <th>ISBN</th><th>Title</th><th>Author</th><th>Price</th><th>Quantity</th><th>Add</th>
                    </tr>
                </thead>
                <tbody>
